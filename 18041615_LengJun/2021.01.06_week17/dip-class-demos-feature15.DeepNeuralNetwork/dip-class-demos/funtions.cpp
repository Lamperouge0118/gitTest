...
int yoloV3()
{
	...
	//coco数据集的名称文件，80类
	string classesFile= "G:\\Projects\\cpp\\15\\coco.names";
	//yolov3网络模型文件
	String yolov3_model = "G:\\Projects\\cpp\\15\\yolov3.cfg";
	//权重
	String weights = "G:\\Projects\\cpp\\15\\yolov3.weights";
...
int openpose()
{
	...
	//读入网络模型和权重文件
	String modelTxt = "G:\\Projects\\cpp\\15\\openpose_pose_coco.prototxt";
	String modelBin = "G:\\Projects\\cpp\\15\\pose_iter_440000.caffemodel";
